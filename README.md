...
5. **[Layout](https://drive.google.com/file/d/1OOc_55C0YkEPC_s81i0s8jf8xEp1v3YR/view?usp=sharing)**: The layout of each scene in the OpenRooms dataset. For `scene0xyz_uv`, its layout can be found in `scene0xyz_uv/uv_mapped.obj`. 
